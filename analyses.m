function [v,w,u,th_prime] = analyses(Omega,psi,in_y,in_z,rdy,rdz,rho,beta,y,alpha,Q,cp,T,N2,th,g)
...
th_prime = (Q(in_z,in_y) / cp ./ T(in_z,in_y) - N2(in_z,in_y) / g .* w) .* th(in_z,in_y) / alpha;
end
